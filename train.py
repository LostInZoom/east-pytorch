...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_images', type=str, default='../data/train_img', help='path to train images')
    parser.add_argument('--train_labels', type=str, default='../data/train_gt', help='path to train labels')
